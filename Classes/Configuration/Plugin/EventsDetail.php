 ...
 */
abstract class EventsDetail implements PluginConfigurationInterface
{
    use PluginConfigurationTrait;

    protected static string $pluginName = 'EventsDetail';

    protected static string $pluginSignature = 't3events_events_detail';

    protected static string $pluginTitle = 'LLL:EXT:t3events/Resources/Private/Language/locallang_be.xlf:plugin.events.detail';

 ...
 */
abstract class Performances implements PluginConfigurationInterface
{
    use PluginConfigurationTrait;

    protected static string $pluginName = 'Performances';

    protected static string $pluginSignature = 't3events_performances';

    protected static string $pluginTitle = 'LLL:EXT:t3events/Resources/Private/Language/locallang_be.xlf:plugin.performances.title';

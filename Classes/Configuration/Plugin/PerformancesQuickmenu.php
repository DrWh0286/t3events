 ...
 */
abstract class PerformancesQuickmenu implements PluginConfigurationInterface
{
    use PluginConfigurationTrait;

    protected static string $pluginName = 'PerformancesQuickmenu';

    protected static string $pluginSignature = 't3events_performancesquickmenu';

 ...
 */
abstract class PerformancesDetail implements PluginConfigurationInterface
{
    use PluginConfigurationTrait;

    protected static string $pluginName = 'PerformancesDetail';

    protected static string $pluginSignature = 't3events_performances_detail';

    protected static string $pluginTitle = 'LLL:EXT:t3events/Resources/Private/Language/locallang_be.xlf:plugin.performances.detail';
